window.app = new Vue({
    ...
    methods: {
        updateLevels() {
            axios.post('/api/getUpdateLevels', {
                username: this.user
            }).then((response) => {
                this.currentLv1 = 43209;
        ...
        tableClick(action, id) {
            $("#img").html('');
            switch (action) {
                case "Driving":
                    $("#img").append("<img src=\"/assets/img/test-golf-game/boy_drive.gif\">");
                    break;
                case "Approach":
                    $("#img").append("<img src=\"/assets/img/test-golf-game/boy_putt.gif\">");
                    break;
                case "Putting":
                    if (id == this.tablelength) {
                        $("#img").append("<img src=\"/assets/img/test-golf-game/boy_victory.gif\">");
                        break;
                    }else{
                        $("#img").append("<img src=\"/assets/img/test-golf-game/boy_putt.gif\">");
                        break;
